...
public final class OrderServiceGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<org.example.gRPC.OrderRequest,
      org.example.gRPC.OrderResponse> getCalculateTotalMethod;
  ...
  public static io.grpc.MethodDescriptor<org.example.gRPC.OrderRequest,
      org.example.gRPC.OrderResponse> getCalculateTotalMethod() {
    io.grpc.MethodDescriptor<org.example.gRPC.OrderRequest, org.example.gRPC.OrderResponse> getCalculateTotalMethod;
    if ((getCalculateTotalMethod = OrderServiceGrpc.getCalculateTotalMethod) == null) {
      synchronized (OrderServiceGrpc.class) {
        if ((getCalculateTotalMethod = OrderServiceGrpc.getCalculateTotalMethod) == null) {
          OrderServiceGrpc.getCalculateTotalMethod = getCalculateTotalMethod =
              io.grpc.MethodDescriptor.<org.example.gRPC.OrderRequest, org.example.gRPC.OrderResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "CalculateTotal"))
              ...
              .setSchemaDescriptor(new OrderServiceMethodDescriptorSupplier("CalculateTotal"))
              .build();
        }
      }
    }
  ...
  public interface AsyncService {
    ...
    /**
     */
    default void calculateTotal(org.example.gRPC.OrderRequest request,
        io.grpc.stub.StreamObserver<org.example.gRPC.OrderResponse> responseObserver) {
      io.grpc.stub.ServerCalls.asyncUnimplementedUnaryCall(getCalculateTotalMethod(), responseObserver);
    }
  }
  ...
  public static final class OrderServiceStub
    ...
    /**
     */
    public void calculateTotal(org.example.gRPC.OrderRequest request,
        io.grpc.stub.StreamObserver<org.example.gRPC.OrderResponse> responseObserver) {
      io.grpc.stub.ClientCalls.asyncUnaryCall(
          getChannel().newCall(getCalculateTotalMethod(), getCallOptions()), request, responseObserver);
    }
  }
  ...
  public static final class OrderServiceBlockingStub
    ...
    /**
     */
    public org.example.gRPC.OrderResponse calculateTotal(org.example.gRPC.OrderRequest request) {
      return io.grpc.stub.ClientCalls.blockingUnaryCall(
          getChannel(), getCalculateTotalMethod(), getCallOptions(), request);
    }
  }
  ...
  public static final class OrderServiceFutureStub
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<org.example.gRPC.OrderResponse> calculateTotal(
        org.example.gRPC.OrderRequest request) {
      return io.grpc.stub.ClientCalls.futureUnaryCall(
          getChannel().newCall(getCalculateTotalMethod(), getCallOptions()), request);
    }
  }

  private static final int METHODID_CALCULATE_TOTAL = 0;
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_CALCULATE_TOTAL:
          serviceImpl.calculateTotal((org.example.gRPC.OrderRequest) request,
              (io.grpc.stub.StreamObserver<org.example.gRPC.OrderResponse>) responseObserver);
          break;
        default:
          ...
          io.grpc.stub.ServerCalls.asyncUnaryCall(
            new MethodHandlers<
              ...
              org.example.gRPC.OrderResponse>(
                service, METHODID_CALCULATE_TOTAL)))
        .build();
  }
  ...
  private static abstract class OrderServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return org.example.gRPC.Order.getDescriptor();
    }
